...
The 'migrate_sdp' project was generated by using the CLI Pipelines template.
...
This folder defines all source code for the migrate_sdp_pipeline pipeline:
...
* Take a look at the sample under "sample_trips_migrate_sdp.py" to get familiar with the syntax.
...
1. To deploy a development copy of this project, type:
    ...
    `[dev yourname] migrate_sdp_pipeline` to your workspace.
